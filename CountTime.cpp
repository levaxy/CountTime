...
int main()
{
    ...
    int HowManyNests = 3, current_content = 0;
    int SpecificConsumGood = 0;
    vector<int> Contents(HowManyNests);
    int CurrentTime = 0, status = 0, PreviousStatus = 0, count = 0, Q = 100, SpecificConsum = 0, Mass = 60, CountGood  = 0;
